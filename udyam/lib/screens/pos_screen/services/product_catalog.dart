...
Map<String, Product> createDefaultCatalog() {
  return {
    '8901063016307': const Product(
      ...
      description: '100g',
      price: 10.00,
      imageUrl: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=200&auto=format&fit=crop&q=60',
    ),
    ...
    '7622300744111': const Product(
      ...
      description: '118g',
      price: 20.00,
      imageUrl: 'https://images.unsplash.com/photo-1558961309-dbdf71799f5a?w=200&auto=format&fit=crop&q=60',
    ),
  };
}
